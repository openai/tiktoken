...
pub fn get_encoding_name_for_model(model: &str) -> Result<String, JsError> {
    match model {
        ...
        "gpt-5" => Ok("o200k_base".into()),
        "gpt-5-2025-08-07" => Ok("o200k_base".into()),
        "gpt-5-nano" => Ok("o200k_base".into()),
        "gpt-5-nano-2025-08-07" => Ok("o200k_base".into()),
        "gpt-5-mini" => Ok("o200k_base".into()),
        "gpt-5-mini-2025-08-07" => Ok("o200k_base".into()),
        "gpt-5-chat-latest" => Ok("o200k_base".into()),
